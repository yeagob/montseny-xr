      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          <div className="mb-8 md:mb-0 text-center md:text-left">
            <h2 className="font-orbitron text-3xl font-bold text-white mb-2">¿LISTO PARA ESCALAR?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-t border-white/10 pt-12">
          <div>
            ...
            <p className="text-gray-500 font-rajdhani">
              Innovación extrema en diseño y desarrollo.<br/>
              Barcelona, España.
            </p>
          </div>
          
          <div className="flex flex-col space-y-2">
             <h4 className="font-orbitron text-white font-bold mb-2">ENLACES</h4>
             <a href="#hero" className="text-gray-400 hover:text-montseny-green">Inicio</a>
             <a href="#portfolio" className="text-gray-400 hover:text-montseny-green">Proyectos</a>
             <a href="#nexus" className="text-gray-400 hover:text-montseny-blue">NEXUS AI</a>
          </div>
        ...
        <div className="mt-12 text-center text-gray-600 font-rajdhani text-sm">
          &copy; {new Date().getFullYear()} Montseny XR. Todos los derechos reservados.
        </div>
      </div>
    </footer>
  );
